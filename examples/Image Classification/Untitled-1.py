...
W,B = define_classification_polytope_w_b(noisySamplesDKW[0],label)
SDF = signedDistanceFunction.polytope(W,B)
verifDKW.specification(SDF)
verifScenario.specification(SDF)

# %%
# Add the noisy samples to the verification problem: 
verifDKW.samples(noisy_logits)
verifScenario.samples(noisy_logits)
